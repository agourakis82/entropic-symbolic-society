...
\usepackage[strings]{underscore} % permite _ em texto sem precisar de \_
\usepackage[T1]{fontenc}

% --- Figuras e layout
\usepackage{graphicx}
\usepackage{xcolor}
\usepackage{float}          % habilita o modificador [H]
\usepackage{booktabs}
\usepackage{geometry}

% --- Citações e bibliografia
% NUNCA use 'cite' junto com natbib
\usepackage[numbers,sort&compress]{natbib}
\usepackage{microtype}
\usepackage{jabbrv}         % abreviações de periódicos (já está no repo)

% --- Caminhos de figuras (SEM erro de chaves)
\makeatletter
\def\input@path{{./}{./figures/}{../NHB_Symbolic_Mainfold/code/figs_final/}{../NHB_Symbolic_Mainfold/figs/}{../figs/}}
\makeatother
\graphicspath{{./}{./figures/}{../NHB_Symbolic_Mainfold/code/figs_final/}{../NHB_Symbolic_Mainfold/figs/}{../figs/}}

% --- Inclusão segura de figuras (não quebra o build se faltar arquivo)
\usepackage{ifthen}
\newcommand{\safeincludegraphics}[2][]{%
  \IfFileExists{#2}{\includegraphics[#1]{#2}}{%
    \fbox{\parbox[c][120pt][c]{0.9\linewidth}{\centering \textbf{Missing figure:}\\[4pt]\texttt{#2}}}}}

\title{[Título do seu manuscrito]}
\author[1]{Demetrios C. Agourakis}
\affil[1]{[Instituição], [Cidade], [País]}
\date{} % wlscirep ignora \date, mas não atrapalha
...
\safeincludegraphics[width=\linewidth]{UMAP_projection.png}
...
\begin{figure}[H]
    \centering
    \safeincludegraphics[width=\textwidth]{figure2_orc_distribution_and_concept_map_en.png}
...
\begin{figure}[htbp]\centering
\safeincludegraphics[width=\linewidth]{Fig_symbolic_heatmap.pdf}
...
\begin{figure}[htbp]\centering
\safeincludegraphics[width=\linewidth]{Fig_symbolic_regimes_map.pdf}
...
\begin{figure}[htbp]\centering
\safeincludegraphics[width=\linewidth]{Fig_collapse_recovery.pdf}
